...
void main() {
  group('MissionFinancialBalance.fromJson — mapping exact des champs serveur', () {
    test('chaque champ Dart lit la clé Firestore *_minor correspondante, sans recalcul', () {
      final balance = MissionFinancialBalance.fromJson('mission_001', _fullBalanceJson());
    ...
    test('round-trip toJson()/fromJson() préserve toutes les valeurs', () {
      final original = MissionFinancialBalance.fromJson('mission_001', _fullBalanceJson());
      final roundTripped = MissionFinancialBalance.fromJson('mission_001', original.toJson());
  ...
  group('MissionFinancialBalance.fromJson — rétro-compatibilité (document partiel/absent)', () {
    ...
    test('un JSON totalement vide ne plante jamais et utilise le missionId fourni', () {
      final balance = MissionFinancialBalance.fromJson('mission_fallback', const {});
