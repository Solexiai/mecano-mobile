...
void main() {
  group('DriverCompensationEngine.calculate — commission de base', () {
    ...
    test('retourne un résultat neutre (unconfigured) si le pricingResult est UNCONFIGURED', () {
      final result = DriverCompensationEngine.calculate(
  ...
  group('DriverCompensationEngine.calculate — pourboire 100% (politique protégée)', () {
    test('un pourboire de 20\$ est intégralement redirigé au chauffeur (100%, pas de ponction)', () {
      final result = DriverCompensationEngine.calculate(
        pricingResult: _pricingResult,
        resolvedCommission: _resolvedStandard,
        commissionConfig: _commissionConfig,
  ...
  group('DriverCompensationEngine.calculate — bonus / ajustements manuels', () {
    test('un bonus manuel positif est ajouté intégralement au gain net du chauffeur', () {
    ...
    test('une pénalité manuelle (montant négatif) réduit le gain net du chauffeur', () {
    ...
    test('plusieurs ajustements manuels (bonus + pourboire) se cumulent correctement', () {
      final bonus = ManualDriverAdjustment(
        id: 'adj_003',
  ...
  group('DriverCompensationEngine.calculate — cohérence avec Founding Driver / commission réduite', () {
    test('un taux de commission Founding Driver (5%) augmente le gain net du chauffeur par rapport au taux standard', () {
      ...
      expect(foundingResult.driverNetMissionEarnings, greaterThan(standardResult.driverNetMissionEarnings));
