...
void main() {
  group('LedgerEntry.isConfirmed / isCompensatingEntry', () {
    test(
      'une entrée standard confirmée sans referenceId n\'est pas une entrée compensatoire',
      () {
    ...
    test(
      'une entrée compensatoire référence bien l\'entrée d\'origine via referenceId',
      () {
    ...
    test(
      'round-trip toJson/fromJson préserve le referenceId d\'une entrée compensatoire',
      () {
        final compensating = LedgerEntry(
