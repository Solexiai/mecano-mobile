...
class PricingScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final deliveryOptions = [
      'Tarif horaire',
      'Tarif au kilomètre',
      'Frais minimum de réservation',
      'Prix fixe par catégorie',
      "Frais d'aide au chargement",
      "Frais d'aide supplémentaire",
      'Frais escaliers',
      "Frais de temps d'attente",
      'Frais arrêt additionnel',
    ];
          ...
          child: Column(
            ...
            children: [
              SectionTitle(
                ...
                subtitle:
                    'Une tarification transparente établie par chaque fournisseur.',
              ),
              ...
              Row(
                children: [
                  ...
                  const Expanded(
                    child: Text(
                      'Paiement sécurisé en ligne intégré (Stripe Connect)',
