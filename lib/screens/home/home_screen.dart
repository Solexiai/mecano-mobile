          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  '${DemoDataService.drivers.length}+ chauffeurs vérifiés',
                  style: TextStyle(
        ...
        children: [
          ...
          SizedBox(
            ...
            child: OutlinedButton(
              onPressed: onCta2,
              child: Text(cta2Label, textAlign: TextAlign.center),
            ),
          ),
        ],
      ),
...
class _HowItWorksPreview extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final steps = [
      ...
      ('3', Icons.people_outline, 'Comparez les chauffeurs'),
          ...
          child: Column(
            ...
            children: [
              SectionTitle(
                ...
                subtitle: 'Un processus simple, transparent, en quelques étapes.',
              ),
              const SizedBox(height: 32),
              isDesktop
                  ? Row(
                      children: steps
                          .map((s) => Expanded(child: _StepTile(s)))
                          .toList(),
                    )
                  : Column(
                      children: steps
  ...
  Widget build(BuildContext context) {
    ...
    final items = [
      (
        ...
        'Chauffeurs vérifiés',
        'Identité et documents examinés avant approbation.'
      ),
      (
        Icons.price_change_outlined,
        'Prix transparents',
        'Une répartition claire des coûts avant toute confirmation.'
      ),
      (
        Icons.chat_bubble_outline,
        'Communication directe',
        'Échangez avec votre chauffeur via la messagerie intégrée.'
      ),
      (
        Icons.star_border_rounded,
        'Avis vérifiés',
        'Seuls les clients ayant complété une réservation peuvent noter.'
      ),
    ];
    return ResponsivePadding(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            const SectionTitle(
              title: 'Pourquoi choisir Movi-k',
              subtitle:
                  'Une plateforme locale conçue pour la confiance et la simplicité.',
            ),
            const SizedBox(height: 32),
            GridView.count(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              isDesktop
                  ? Row(
                      children: DemoDataService.testimonials
                          .map(
                            (r) => Expanded(
                              child: Padding(
                                ...
                                child: _TestimonialCard(
                                  review: r,
                                  label: t('testimonial_placeholder_label'),
                                ),
                              ),
                            ),
                          )
